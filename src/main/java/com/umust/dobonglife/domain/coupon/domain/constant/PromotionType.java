package com.umust.dobonglife.domain.coupon.domain.constant;

import lombok.Getter;

@Getter
public enum PromotionType { // TODO: 추후에 캐시로 올릴 예정 (현재: 빠른 개발을 위함)
    ...
    PromotionType(String description, String imageUrl) {
