...
import com.umust.dobonglife.domain.user.domain.policy.UserPolicy;
...
public class User extends BaseEntity {
    ...
    public void handleDeletion() {
        this.deleteCount++;
        if (this.deleteCount >= UserPolicy.PENALTY_THRESHOLD) {
            applyPenalty();
        }
    }
    ...
    private boolean isPenaltyExpired() {
        return LocalDateTime.now().isAfter(this.blockedAt.plusDays(UserPolicy.PENALTY_DAYS));
    }
